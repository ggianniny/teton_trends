...
**Boxplot of all summer data over time grouped by source**

All summer data, free Y axis:

```{r}
boxplot.pal <- c(brewer.pal(4, "Purples"), brewer.pal(3, "Greens"), brewer.pal(4, "Oranges"))
...
```{r}
boxplot.pal <- c(brewer.pal(4, "Purples"), brewer.pal(4, "Greens"), brewer.pal(4, "Oranges"))
