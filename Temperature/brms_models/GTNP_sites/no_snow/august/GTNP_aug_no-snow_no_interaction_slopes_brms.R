#GTNP_aug_no_snow_ fixed slopes, only main effects

# Fixed effects of year, source (No interaction)
# random intercepts for year and site

# terminal lines to run
# r
# source("Temperature/brms_models/GTNP_sites/no_snow/august/GTNP_aug_no-snow_no_interaction_slopes_brms.R")
