...
Manual removal of overlap between stream temp + Grand Targhee air temp. 
...
```{r}
ggplot(filter(fully_cleaned7, site == "s_ak_basin", year ==2019|year==2020e), aes(x = date1, y = temp_c))+
  geom_point()+
  theme_classic()
```
...
```{r}
ggplot(filter(fully_cleaned7, site == "s_ak_basin", date1 >= "2019-08-15" & date1 <= "2019-10-20"), aes(x = date_tm, y = temp_c))+
  geom_point()+
  theme_classic()
```
...
```{r}
ggplot(filter(fully_cleaned7, site == "s_ak_basin", date1 >= "2020-08-15" & date1 <= "2020-11-11"), aes(x = date_tm, y = temp_c))+
  geom_point()+
  theme_classic()
```
