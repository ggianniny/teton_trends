# Random intercept and slope for June-August in GTNP 
...
mean_year <- mean(unique(temp_summer$year))
sd_year <- sd(unique(temp_summer$year))
mean_temp <- mean(unique(temp_summer$temp_c))
sd_temp <- sd(unique(temp_summer$temp_c))
